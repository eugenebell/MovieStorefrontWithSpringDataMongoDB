...
public class Movie {
	...
	public Movie(String title, Double price, Integer rating,
			Integer year, String posterFileName, String displayRunTime,
			String summary, String actorsDisplay, String directorsDisplay,
			String producersDisplay, String studioDisplay) {
		super();
		this.title = title;
		this.price = price;
		this.rating = rating;
